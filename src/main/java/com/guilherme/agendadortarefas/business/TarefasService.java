...
public class TarefasService {
    ...
    public List<TarefasDTORecord> buscaTarefasAngendadasPorPeriodo(LocalDateTime dataInicial, LocalDateTime dataFinal) {
    ...
    public List<TarefasDTORecord> buscarTarefaPorEmail(String token) {
